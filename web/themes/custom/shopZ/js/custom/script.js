...
(function ($, Drupal) {
  ...
  $('input#edit-contact-information-email').val('zelenoe.pole@gmail.com');
  $('#shipping-information-wrapper select.country').val('BY');
  $('#shipping-information-wrapper input.given-name').val('Карл');
  $('#shipping-information-wrapper input.family-name').val('Карлов');
  $('#shipping-information-wrapper input.organization').val('');
  $('#shipping-information-wrapper input.address-line1').val('ул. Уборевича, 138-6');
  $('#shipping-information-wrapper input.address-line2').val('');
  $('#shipping-information-wrapper input.locality').val('Минск');
  $('#shipping-information-wrapper select.administrative-area').val('');
  $('#shipping-information-wrapper input.postal-code').val('220077');
  ...
  $("div[id^='payment-information-wrapper'] select.country").val('BY');
  ...
  $("div[id^='payment-information-wrapper'] input.address-line1").val('688 W Charles Mound Rd33');
  $("div[id^='payment-information-wrapper'] input.address-line2").val('');
  $("div[id^='payment-information-wrapper'] input.locality").val('Минск');
  $("div[id^='payment-information-wrapper'] select.administrative-area").val('IL');
  $("div[id^='payment-information-wrapper'] input.postal-code").val('220077');
    ...
    $.ajax( this.href, {
      complete: function(data) {
        if ( notStoredCard ) {
          ...
          $("div[id^='payment-information-wrapper'] input.family-name").val('Mound');
          $("div[id^='payment-information-wrapper'] input.organization").val('');
          $("div[id^='payment-information-wrapper'] input.address-line1").val('688 W Charles Mound Rd222');
          $("div[id^='payment-information-wrapper'] input.address-line2").val('');
          $("div[id^='payment-information-wrapper'] input.locality").val('минск2');
